...
$lots = [
    ["nameproduct" => "2014 Rossignol District Snowboard","category" => "Доски и лыжи","price" => 10999,"urlimg" => "img/lot-1.jpg"],
    ["nameproduct" => "DC Ply Mens 2016/2017 Snowboard","category" => "Доски и лыжи","price" => 159999,"urlimg" => "img/lot-2.jpg"],
    ["nameproduct" => "Крепления Union Contact Pro 2015 года размер L/XL","category" => "Крепления","price" => 8000,"urlimg" => "img/lot-3.jpg"],
    ["nameproduct" => "Ботинки для сноуборда DC Mutiny Charocal","category" => "Ботинки","price" => 10999,"urlimg" => "img/lot-4.jpg"],
    ["nameproduct" => "Куртка для сноуборда DC Mutiny Charocal","category" => "Одежда","price" => 7500,"urlimg" => "img/lot-5.jpg"],
    ["nameproduct" => "Маска Oakley Canopy","category" => "Разное","price" => 5400,"urlimg" => "img/lot-6.jpg"]
];
?>
<!DOCTYPE html>
<html lang="ru">
