...
$lots = [
    ...
    ["nameproduct" => "Ботинки для сноуборда DC Mutiny Charocal","lot" => "Ботинки","price" => 10999,"urlimg" => "img/lot-4.jpg"],
    ["nameproduct" => "Куртка для сноуборда DC Mutiny Charocal","lot" => "Одежда","price" => 7500,"urlimg" => "img/lot-5.jpg"],
    ["nameproduct" => "Маска Oakley Canopy","lot" => "Разное","price" => 5400,"urlimg" => "img/lot-6.jpg"]
];
?>
<!DOCTYPE html>
<html lang="ru">
